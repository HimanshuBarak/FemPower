...
def follicular(request):
    return render(request, 'website/follicular.html')


def ovulation(request):
    return render(request, 'website/ovulation.html')

def luteral(request):
    return render(request, 'website/luteral.html')

def menstrual(request):
    return render(request, 'website/menstrual.html')
...
def buy(request):
    ...
    filename = r"C:\\Users\\jayit\\Downloads\\PROJECTS\\hack\\Em-Power\\AI DIET PLANNER Microservice\\website\\csvfile\\recent_activity.csv"
...
def order(request):
    if Profile.objects.get(number=request.user.username).second_time:
        filename = r"C:\\Users\\jayit\\Downloads\\PROJECTS\\hack\\Em-Power\\AI DIET PLANNER Microservice\\website\\csvfile\\recent_activity.csv"
        filename2 = r"C:\\Users\\jayit\\Downloads\\PROJECTS\\hack\\Em-Power\\AI DIET PLANNER Microservice\\website\\csvfile\\recent_activity.csv"
