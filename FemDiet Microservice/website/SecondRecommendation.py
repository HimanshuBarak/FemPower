...
def Recommend(request):
    if request.user.is_authenticated:
        ...
        profiles = pd.read_csv(
            r'C:\\Users\\jayit\\Downloads\\PROJECTS\\hack\\Em-Power\\AI DIET PLANNER Microservice\\website\\csvfile\\user_Profiles.csv')
        # recent activities of current user (meals liked,rated,searched,Purchased)
        recent_activity = pd.read_csv(
            r'C:\\Users\\jayit\\Downloads\\PROJECTS\\hack\\Em-Power\\AI DIET PLANNER Microservice\\website\\csvfile\\recent_activity.csv')
        dataset = pd.read_csv(
            r'C:\\Users\\jayit\\Downloads\\PROJECTS\\hack\\Em-Power\\AI DIET PLANNER Microservice\\website\\dataset.csv')  # main dataset
